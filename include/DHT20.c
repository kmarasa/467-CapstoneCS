...
{
    int result = i2c_read_blocking(DHT20_I2C, DHT20_ADDRESS, sensor->bytes, 7, false);
...
int take_measurement(DHT20 *sensor)
{
    ...
    int trigger_measure = i2c_write_blocking(DHT20_I2C, DHT20_ADDRESS, request, 3, false);
