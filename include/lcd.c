...
/*
Connections from the Pico to the LCD for this humidity sensor project:
...
void lcd_show_temperature(float temperature) {
  char line[14]; // max line is "100.00% deg C"
  snprintf(line, sizeof(line), "%.2f deg C", temperature);
